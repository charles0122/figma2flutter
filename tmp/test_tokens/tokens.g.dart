...
class DefaultTokens extends ITokens {
  ...
  @override
  CompositionTokens get composition => const CompositionTokens();
  @override
  ShadowTokens get shadow => const ShadowTokens();
  @override
  BorderTokens get border => const BorderTokens();
  @override
  SizeTokens get size => const SizeTokens();
  @override
  GradientTokens get gradient => const GradientTokens();
}
...
class DefaultBorderTokens extends BorderTokens {
  ...
  static const Border borderDefault = Border.all(color: const Color(0xFF000000), width: 5.0, style: BorderStyle.solid);
  static const Border borderSmall = Border.all(color: const Color(0xFF000000), width: 2.0, style: BorderStyle.solid);
}
...
class DefaultSizeTokens extends SizeTokens {
  ...
  static const Size sizingDefault = const Size(16.0, 16.0);
}
